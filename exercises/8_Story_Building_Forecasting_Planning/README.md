...
1.	For this exercise, we are working with the "SAP_FI_CLM_LIQUIDITY_PLANNING" story which can be found in your MyFiles folder created beforehand by copying "TechEd2022_DA280_SampleContent" as "TechEd2022_DA280_/LASTNAME/". 
